...
cd "$SCRIPT_DIR"
clang-18 -S -emit-llvm --target=riscv32-unknown-elf -O3 -fno-builtin-printf -fno-builtin-memcpy -fno-builtin-memmove \
...
llc-18 -march=riscv32 -mattr=+m builtin.ll -o builtin_intermediate.s -O3
